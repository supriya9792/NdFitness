...
public class AddEnquirySpinnerAdapter extends BaseAdapter {
    ...
    public AddEnquirySpinnerAdapter(Context context, ArrayList<Spinner_List> itemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.add_enquiry_spinner_list, null);
