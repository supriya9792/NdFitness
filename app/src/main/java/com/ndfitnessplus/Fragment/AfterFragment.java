...
public class AfterFragment extends Fragment {
    ...
    // Bitmap bitmap;
    String ConvertImage="";
    String member_id,After_Photo;
    // ImageView CapturedImage;
    private Uri uri;
    private Uri filePath;
    Bitmap bitmap;
    ImageView after_image;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        after_image=(ImageView)view.findViewById(R.id.after_image);
        ...
        After_Photo = bundle.getString("After_Photo");
        After_Photo.replace("\"", "");
        ...
        if(!(After_Photo.equals("null")||After_Photo.equals(""))){
            String domainurl= SharedPrefereneceUtil.getDomainUrl((Activity)getActivity());
            String url= domainurl+ServiceUrls.IMAGES_URL + After_Photo;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                after_image.setImageURI(result.getUri());
                try {
    ...
    private void uploadimageClass() {
        ...
        class UploadImageTrackClass extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                ProfileDetails.put("before_after", "After");
                Log.d(TAG, "before_after: "+"After");
